...
namespace DocuCalendar.Infrastructure.Migrations
{
    ...
    [Migration("20260922101427_AddCalendarContexts")]
    partial class AddCalendarContexts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DocuCalendar.Domain.Entities.CalendarContext", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CalendarId", "TenantContextId")
                        .IsUnique();

                    b.HasIndex("TenantId", "TenantContextId");

                    b.ToTable("CalendarContexts", "calendar");
                });
